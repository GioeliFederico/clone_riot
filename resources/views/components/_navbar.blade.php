<nav
class="navbar navbar-expand-md nav-bar-custom navbar-dark position-fixed"
...
<div
    ...
    style="height: 100%"
>
    {{-- <a id="btn-logo" class="navbar-brand btn">
        <div class="btn-fist-logo" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="btnLogoCollapse"></div>
    </a> --}}
    {{-- <div
    id="btn-logo"
    class="navbar-brand btn"
    data-bs-toggle="collapse"
    href="#btnLogoCollapse"
    role="button"
    aria-expanded="false"
    aria-controls="btnLogoCollapse"
    >
        <p class="navbar-brand btn btn-fist-logo"></p>
    </div>
        <div class="collapse collapse-fist-logo" id="btnLogoCollapse">
        <h2 class="collapse-fist-logo-content karla">RIOT GAMES</h2>
    </div> --}}

    <div
    id="btn-logo"
    class="navbar-brand btn position-relative"
    role="button"
    aria-expanded="false"
    aria-controls="btnLogoCollapse"
    >
        <p id="btn-fist-logo" class="navbar-brand btn"></p>
    </div>
    <div id="collapse-logo">
        <div id="collapse-logo-content" class="container-fluid py-4 px-0">
            <div class="row mx-5 pb-3">
                <div class="col-6"><h2 class="karla">RIOT GAMES</h2></div>
                <div class="col-6 d-flex justify-content-end align-items-center">
                    <h6 class="monserrat px-5 my-auto" style="font-size: 12px">VISITA RIOT GAMES</h6>
                    <img src="https://image.flaticon.com/icons/png/128/2976/2976286.png" alt="" style="padding:5px; height: 20px; background-color:rgb(204, 204, 204); opacity: 50%">
                </div>
            </div>
            <div class="row mx-5 pb-5" >
                <div class="col-6 d-flex p-0" style="padding-right: 10px !important; gap: 20px">
                    <div class="card collapse-card border-0" style="max-width: 50%">
                        <img src="https://images.contentstack.io/v3/assets/blt0eb2a2986b796d29/blt5f23e11f3e834cab/60875126e650b13fbe214440/TFT_5_PromoCard.jpg??&format=pjpg&quality=85" class="collapse-img" alt="...">
                        <div class="card-body">
                          <h5 class="card-title karla">Giudizio è arrivato. Scaccerai l'oscurità o cederai alla sua morsa?</h5>
                        </div>
                    </div>
                    <div class="card collapse-card border-0" style="max-width: 50%">
                        <img src="https://images.contentstack.io/v3/assets/blt0eb2a2986b796d29/blt9344e6a91428ebde/6039db1d044df63b24e955a0/LoR_Shurima_Riot_Bar_Application_Switcher_Riot_Bar_660x428.jpg??&format=pjpg&quality=85" class="collapse-img" alt="...">
                        <div class="card-body">
                          <h5 class="card-title karla">Risveglia il tuo impero con la nuova espansione di Legends of Runeterra.</h5>
                        </div>
                    </div>
                </div>
                <div class="col-6 d-flex p-0" style="padding-left: 10px !important; gap: 20px">
                    <div class="card collapse-card border-0" style="width: 25%">
                        <img src="https://images.contentstack.io/v3/assets/blt0eb2a2986b796d29/blt5abbad4f1d1da663/602457cff4a7946af0338221/LOL_Key_Art_2021_318x428_RiotBar.jpg??&format=pjpg&quality=85" class="collapse-img" alt="...">
                        <div class="card-body">
                          <h5 class="card-title karla">Giudizio è arrivato. Scaccerai l'oscurità o cederai alla sua morsa?</h5>
                        </div>
                    </div>
                    <div class="card collapse-card border-0" style="width: 25%">
                        <img src="https://images.contentstack.io/v3/assets/blt0eb2a2986b796d29/bltc380ed7da4dd15dd/608395a9e0753d466aa6d2df/TFT_Set5_RiotBarCard_v1.jpg??&format=pjpg&quality=85" class="collapse-img" alt="...">
                        <div class="card-body">
                          <h5 class="card-title karla">Giudizio è arrivato. Scaccerai l'oscurità o cederai alla sua morsa?</h5>
                        </div>
                    </div>
                    <div class="card collapse-card border-0" style="width: 25%">
                        <img src="https://images.contentstack.io/v3/assets/blt0eb2a2986b796d29/blt0cfdd9427ea0ee59/6039db102eee966ee2e3d552/LoR_Shurima_Riot_Bar_Application_Switcher_318X428.jpg??&format=pjpg&quality=85" class="collapse-img" alt="...">
                        <div class="card-body">
                          <h5 class="card-title karla">Giudizio è arrivato. Scaccerai l'oscurità o cederai alla sua morsa?</h5>
                        </div>
                    </div>
                    <div class="card collapse-card border-0" style="width: 25%">
                        <img src="https://images.contentstack.io/v3/assets/blt0eb2a2986b796d29/blte94074969e8e82fe/5e618391d5a7d573058228ba/Riot_Nav_Bar_Graphic_318x428.jpg??&format=pjpg&quality=85" class="collapse-img" alt="...">
                        <div class="card-body">
                          <h5 class="card-title karla">Giudizio è arrivato. Scaccerai l'oscurità o cederai alla sua morsa?</h5>
                        </div>
                    </div>
    ...
    <svg class="d-none d-md-flex" style="width:4px; height:30%">
        <line x1="0" y1="0" x2="0" y2="100" style="stroke:gray;stroke-width:4" />
    </svg>

    <div class="d-md-none text-white">
    <a href="https://euw.leagueoflegends.com/it-it/">
        <svg
    ...
    <div class="d-none d-md-flex language" style="height: 100%">
    <ul
        class="navbar-nav me-auto mb-2 mb-md-0 d-flex align-items-center justify-content-around"
        style="width: 100%; height: 100%; padding-left: 30px"
    >
        <li class="nav-item">
        ...
        <a
            ...
            href="#"
        >
            <div class="pe-2">NOTIZIE</div>
            <i class="fas fa-sort-down pb-1"></i>
        </a>
        <div class="notizie-dropdown-content">
            <a class="karla" href="">TUTTO</a>
            <a class="karla" href="">AGGIORNAMENTI DI GIOCO</a>
            <a class="karla" href="">ESPORT</a>
            <a class="karla" href="">DEV</a>
            <a class="karla" href="">STORIA</a>
            <a class="karla" href="">MEDIA</a>
            <a class="karla" href="">MERCH</a>
            <a class="karla" href="">COMMUNITY</a>
            <a class="karla" href="">RIOT GAMES</a>
        </div>
        </li>
        <li
        class="nav-item nav-item-custom d-flex align-items-center"
        ...
        <a
            ...
            href="#"
        >
            <div class="pe-2">SCOPRI</div>
            <i class="fas fa-sort-down pb-1"></i>
        </a>
        <div class="notizie-dropdown-content">
            <a class="karla" href="">LEAGUE DISPLAYS</a>
        </div>
        </li>
        <li
        class="nav-item nav-item-custom d-flex align-items-center"
        ...
        <a
            ...
            href="#"
        >
            <div class="pe-2">MERCHANDISE</div>
            <svg
            width="7"
            height="7"
            class="inline-block link-out non-hover"
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdown04">
            <li><a class="dropdown-item" href="#">English (NA)</a></li>
            <li><a class="dropdown-item" href="#">English (EUW)</a></li>
            <li>
            <a class="dropdown-item" href="#">Deutsch</a>
            </li>
            <li>
            <a class="dropdown-item" href="#">Espanol (EUW)</a>
            </li>
            <li>
            ...
            <li>
            <a class="dropdown-item" href="#">English (EUNE)</a>
            </li>
            <li>
            <a class="dropdown-item" href="#">Polski</a>
            </li>
            <li>
            <a class="dropdown-item" href="#">English (OCE)</a>
            </li>
        </ul>
        </li>
        <li class="nav-item dropdown">
        <ul class="dropdown-menu">
            <li>
            <h6 class="dropdown-header text-white">Dropdown header</h6>
            </li>
    ...
    <div class="w-100 d-flex justify-content-end mx-5">
        <ul class="navbar-nav">
        @guest
            @if (Route::has('login'))
                <li class="nav-item">
