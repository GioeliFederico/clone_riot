    ...
    <div id="role-container" class="container">
        ...
        <div class="row role-row bg-white align-items-end justify-content-center">
            <div class="col-2 role-item d-flex flex-column align-items-center position-relative">
                ...
                <svg class="role-svg-line" width="1"><line x1="0" y1="0" x2="0" y2="25" fill="gray" style="stroke:#d0a85c; stroke-width:1" /></svg>
                <svg class="role-svg-point" height="24" width="24"><circle cx="11" cy="11" r="5" stroke="transparent" fill="gray" /></svg>
                <svg class="role-svg-point-border" style="stroke:black; fill:none; stroke-width:1" width="24" height="24"><path></path></svg>
            </div>
            <div class="col-2 role-item d-flex flex-column align-items-center position-relative">
